...
from resources.empdetails import empdetailsblueprint as EmpDetailsBlueprint
...
def create_app():
    ...
    # register Employee Details blueprint
    api.register_blueprint(EmpDetailsBlueprint)
